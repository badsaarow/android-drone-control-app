...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String wifiAddress = "192.168.192.35"; //"100.73.251.110"; //this.wifiIpAddress(this);
        Log.i("IP: ", wifiAddress);
        androidWebServer = new WebServer(null, 8888);
        try {
            androidWebServer.start(1000); // socket timeout: 1s
