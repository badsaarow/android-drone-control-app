...
//        try {
//            DJISampleApplication.getEventBus().post(new ViewWrapper( new com.dji.sdk.sample.demo.flightcontroller.VirtualStickView(getContext()), R.string.activity_component_list));
//            //private ViewWrapper componentList =
//            //            new ViewWrapper(new DemoListView(getContext()), R.string.activity_component_list);
//        } catch (Exception e) {
//            e.printStackTrace();
